...
public abstract class DBHistoricalPrices {
    ...
    static LinkedHashMap<Long, Double> getDBPrices(String ticker, DataSource dataSource, DateTime earliestCloseDate) {
	LOGGER.debug("Entering DBHistoricalPrices.getDBPrices(String {}, DataSource {}, DateTime {} ({})", 
		     ticker, dataSource.toString(), earliestCloseDate.getMillis(), earliestCloseDate.toString());
    ...
    public static void addStockPrice(String ticker, long dateEpoch, double adjClose, DataSource dataSource) {
	LOGGER.debug("Entering DBHistoricalPrices.addStockPrice(String {}, long {}, double {}, DataSource {})", ticker, dateEpoch, adjClose, dataSource);
        Connection dbConnection = null;
	PreparedStatement sqlStatement = null;
