...
public class TradingSession {
   ...
   TradingSession(Portfolio portfolio, WatchList watchList) {
      LOGGER.debug("Creating new TradingSession() with portfolio {} and watchlist {}", portfolio.getName(), watchList);
