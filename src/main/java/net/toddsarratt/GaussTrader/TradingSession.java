...
public class TradingSession {
	...
	private static final Integer[] JULIAN_HOLIDAYS_2017 = {2, 16, 51, 104, 149, 185, 247, 327, 359};
	private static final Integer[] JULIAN_HOLIDAYS_2018 = {1, 15, 50, 89, 148, 185, 246, 326, 359};
	private static final Integer[] JULIAN_HOLIDAYS_2019 = {1, 21, 49, 109, 147, 185, 245, 332, 359};
	private static final ImmutableMap<Integer, List<Integer>> HOLIDAY_MAP =
			ImmutableMap.<Integer, List<Integer>>builder()
					...
					.put(2018, Arrays.asList(JULIAN_HOLIDAYS_2018))
					.put(2019, Arrays.asList(JULIAN_HOLIDAYS_2019))
					.build();
	private static final Integer[] JULIAN_1PM_CLOSE_2017 = {184, 328};
	private static final Integer[] JULIAN_1PM_CLOSE_2018 = {184, 327, 358};
	private static final Integer[] JULIAN_1PM_CLOSE_2019 = {184, 333, 358};
	private static final ImmutableMap<Integer, List<Integer>> EARLY_CLOSE_MAP =
			ImmutableMap.<Integer, List<Integer>>builder()
					.put(2017, Arrays.asList(JULIAN_1PM_CLOSE_2017))
					.put(2018, Arrays.asList(JULIAN_1PM_CLOSE_2018))
					.put(2019, Arrays.asList(JULIAN_1PM_CLOSE_2019))
					.build();
